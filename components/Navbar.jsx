    ...
    >
      ...
      >
        ...
        <div
          className={
            nav
              ? "fixed left-0 top-0 right-0 bottom-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-6 ease-in duration-500"
        ...
        >
          ...
          <div className="py-4 flex flex-col">
            ...
            <div className="absolute bottom-0">
              ...
              <div className="flex items-center gap-5 justify-between my-4 w-full sm:w-[80%]">
                <a
